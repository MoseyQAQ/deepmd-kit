...
doc_les = "Fit an energy model with Latent Ewald Summation method is included to descirbe the long-range interaction."
...
def fitting_les() -> list[Argument]:
    ...
    doc_les_config_file = (
        "The configuration file for LES, which is in yaml format"
